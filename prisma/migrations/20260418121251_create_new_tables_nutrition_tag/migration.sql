...
-- CreateTable
CREATE TABLE "_RecipeToRecipeTeg" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_RecipeToRecipeTeg_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateIndex
CREATE UNIQUE INDEX "nutrition_fact_recipe_id_key" ON "nutrition_fact"("recipe_id");

-- CreateIndex
CREATE UNIQUE INDEX "recipe_tags_name_key" ON "recipe_tags"("name");

-- CreateIndex
CREATE INDEX "_RecipeToRecipeTeg_B_index" ON "_RecipeToRecipeTeg"("B");

-- AddForeignKey
ALTER TABLE "nutrition_fact" ADD CONSTRAINT "nutrition_fact_recipe_id_fkey" FOREIGN KEY ("recipe_id") REFERENCES "recipes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_RecipeToRecipeTeg" ADD CONSTRAINT "_RecipeToRecipeTeg_A_fkey" FOREIGN KEY ("A") REFERENCES "recipes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_RecipeToRecipeTeg" ADD CONSTRAINT "_RecipeToRecipeTeg_B_fkey" FOREIGN KEY ("B") REFERENCES "recipe_tags"("id") ON DELETE CASCADE ON UPDATE CASCADE;
