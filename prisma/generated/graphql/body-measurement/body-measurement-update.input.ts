...
import { UserUpdateOneRequiredWithoutMeasurementNestedInput } from '../user/user-update-one-required-without-measurement-nested.input';
...
export class BodyMeasurementUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutMeasurementNestedInput, {nullable:true})
