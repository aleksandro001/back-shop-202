...
import { UserCreateNestedOneWithoutMeasurementInput } from '../user/user-create-nested-one-without-measurement.input';
...
export class BodyMeasurementCreateInput {
    ...
    @Field(() => UserCreateNestedOneWithoutMeasurementInput, {nullable:false})
